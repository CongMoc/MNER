...
def build_system_prompt(entity_types):
    ...
    return (
        "You are a named entity recognition assistant. Given a sentence, extract all "
        f"named entities. Valid entity types: {types_str}. "
...
def build_messages(system_prompt, sentence, entities=None):
    messages = [
